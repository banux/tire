...
This Readme provides a brief overview of _Tire's_ features. The more detailed documentation is at <http://github.com/karmi/retire/>.
...
in [examples/tire-dsl.rb](http://github.com/karmi/retire/).
